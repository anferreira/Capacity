...
public
decimal TarRunQty{
	get { return tarRunQty; }
	set { if (this.tarRunQty != value){
			this.tarRunQty = value;
			//Notify("TarRunQty");
		}
	}
}
...
public
decimal HourLTCum{
	get { return hourLTCum; }
	set { if (this.hourLTCum != value){
			this.hourLTCum = value;
			//Notify("HourLTCum");
		}
	}
}
