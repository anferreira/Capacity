...
~DataBaseAccess(){
    ...
    if (!Configuration.SqlRepositoryType.Equals(ACCESS) && !Configuration.SqlRepositoryType.Equals(POSTGRESQL)){
		if ((connection != null) && (connection.State == System.Data.ConnectionState.Open)){
            try{
                connection.Close();
                connection.Dispose();
...
int executeUpdate(String statement){        
    statement = statement.Replace("rp1268d", "rp1268d1").Replace("RP1268D","RP1268D1");  //AF delete that line    

    /*
    //test
    statement = statement.Replace("rp1268d1", "rp1268d2").Replace("RP1268D1","RP1268D2");  //AF delete that line
    statement = statement.Replace("rp1268h", "rp1268h2").Replace("RP1268H","RP1268H2");  //AF delete that line
    statement = statement.Replace("rp1268s", "rp1268s2").Replace("RP1268S","RP1268S2");  //AF delete that line    
       
    //test2
    statement = statement.Replace("rp1268d1", "rp1268d4").Replace("RP1268D1","RP1268D4");  //AF delete that line
    statement = statement.Replace("rp1268h", "rp1268h4").Replace("RP1268H","RP1268H4");  //AF delete that line
    statement = statement.Replace("rp1268s", "rp1268s4").Replace("RP1268S","RP1268S4");  //AF delete that line    
    */
       
    //test5
    statement = statement.Replace("rp1268d1", "rp1268d5").Replace("RP1268D1","RP1268D5");  //AF delete that line
    statement = statement.Replace("rp1268h", "rp1268h5").Replace("RP1268H","RP1268H5");  //AF delete that line
    statement = statement.Replace("rp1268s", "rp1268s5").Replace("RP1268S","RP1268S5");  //AF delete that line    
    ...
    lock (this){
        ...
        command.CommandTimeout = 30; //AF set 30 seconds
...
NotNullDataReader executeQuery(String sqlQuery){   
    sqlQuery = sqlQuery.Replace("rp1268d", "rp1268d1").Replace("RP1268D","RP1268D1");  //AF delete that line
   /*
    //test
    sqlQuery = sqlQuery.Replace("rp1268d1", "rp1268d2").Replace("RP1268D1","RP1268D2"); //AF delete that line
    sqlQuery = sqlQuery.Replace("rp1268h", "rp1268h2").Replace("RP1268H","RP1268H2");  //AF delete that line
    sqlQuery = sqlQuery.Replace("rp1268s", "rp1268s2").Replace("RP1268S","RP1268S2");  //AF delete that line
    
    //test2
    sqlQuery = sqlQuery.Replace("rp1268d1", "rp1268d4").Replace("RP1268D1","RP1268D4"); //AF delete that line
    sqlQuery = sqlQuery.Replace("rp1268h", "rp1268h4").Replace("RP1268H","RP1268H4");  //AF delete that line
    sqlQuery = sqlQuery.Replace("rp1268s", "rp1268s4").Replace("RP1268S","RP1268S4");  //AF delete that line    
    */
     //test5
    sqlQuery = sqlQuery.Replace("rp1268d1", "rp1268d5").Replace("RP1268D1","RP1268D5");//AF delete that line
    sqlQuery = sqlQuery.Replace("rp1268h", "rp1268h5").Replace("RP1268H","RP1268H5");  //AF delete that line
    sqlQuery = sqlQuery.Replace("rp1268s", "rp1268s5").Replace("RP1268S","RP1268S5");  //AF delete that line    
	...
	lock(this){
		...
		for(int i = 0; i < 5 && ioexc; i++){
            ...
            command.CommandTimeout = 0; //AF so no limit on timeout
