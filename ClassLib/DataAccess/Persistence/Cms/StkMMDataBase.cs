...
void load(NotNullDataReader reader){    
    ...
    if (Configuration.CmsVersion.Equals(Constants.CMS_VERSION_5_2)){
        ...
        try {
            this.AVCTME = DateUtil.decimalMinutesToHoursHHMM(reader.GetDecimal("AVCTME"));            
        }
        catch{
        ...
        try{
            this.AVUTME = DateUtil.decimalMinutesToHoursHHMM(reader.GetDecimal("AVUTME"));              
        }catch{
        ...
        try{
            this.AVFUTR = DateUtil.decimalMinutesToHoursHHMM(reader.GetDecimal("AVFUTR"));              
        }catch{
        ...
        try{
             this.AVFUT41 = DateUtil.decimalMinutesToHoursHHMM(reader.GetDecimal("AVFUT41"));                   
        }catch{
            this.AVFUT41 = reader.GetDateTime("AVFUT41");
        }
        try{
            this.AVFUT42 = DateUtil.decimalMinutesToHoursHHMM(reader.GetDecimal("AVFUT42"));               
        }catch{
            this.AVFUT42 = reader.GetDateTime("AVFUT42");
        }
        try{
            this.AVFUT43 = DateUtil.decimalMinutesToHoursHHMM(reader.GetDecimal("AVFUT43"));
        }catch{
             this.AVFUT43 = reader.GetDateTime("AVFUT43");
        }
        try{
            this.AVFUT44 = DateUtil.decimalMinutesToHoursHHMM(reader.GetDecimal("AVFUT44"));            
        }catch{
            this.AVFUT44 = reader.GetDateTime("AVFUT44");
        }
        try{
            this.AVFUT45 = DateUtil.decimalMinutesToHoursHHMM(reader.GetDecimal("AVFUT45"));            
        }catch{
    ...
    else
    {
        //remove in 5.2
        try
        { //AF 217/09/21 because issue on Concord/PLCORP
        ...
        this.AVPPAP = "";
        this.AVCUSR = "";
        this.AVCTME = DateUtil.MinValue;
        this.AVUUSR = "";
        this.AVUDAT = DateUtil.MinValue;
        this.AVUTME = DateUtil.MinValue;
        this.AVSIZC = "";
        this.AVSTLC = "";
        this.AVCOLC = "";
        this.AVASSC = "";
        ...
        this.AVFUTM = "";
        this.AVFUTP = "";
        this.AVFUTQ = DateUtil.MinValue;
        this.AVFUTR = DateUtil.MinValue;
        this.AVOLDD2 = "";
        this.AVFUTG = 0;
        this.AVRECU = "";
        this.AVFTMF = 0;
        this.AVRECC = "";
        this.AVFUTJ = "";
        this.AVSPDT = DateUtil.MinValue;
        this.AVBBDT = DateUtil.MinValue;
        this.AVPSOR = "";
        this.AVFUTO = "";
        this.AVDENC = "";
        this.AVDREL = "";
        this.AVDDAT = DateUtil.MinValue;
        this.AVFUTE = "";
        this.AVDRWS2 = "";
        this.AVDRWL2 = "";
        this.AVDENC2 = "";
        this.AVDREL2 = "";
        this.AVDDAT2 = DateUtil.MinValue;
        this.AVFUTF = "";
        this.AVSTCL = "";
        this.AVVLCD = "";
        this.AVSPPP = 0;
        ...
        this.AVFUT34 = 0;
        this.AVFUT35 = 0;
        this.AVFUT36 = DateUtil.MinValue;
        this.AVFUT37 = DateUtil.MinValue;
        this.AVFUT38 = DateUtil.MinValue;
        this.AVFUT39 = DateUtil.MinValue;
        this.AVFUT40 = DateUtil.MinValue;
        this.AVFUT41 = DateUtil.MinValue;
        this.AVFUT42 = DateUtil.MinValue;
        this.AVFUT43 = DateUtil.MinValue;
        this.AVFUT44 = DateUtil.MinValue;
        this.AVFUT45 = DateUtil.MinValue;
        this.AVUDFT = "";
        this.AVFRML = "";
    }
    ...
    /*this.AVPART = reader.GetString(0);
    this.AVDISC = reader.GetString(1);
    this.AVLEAD = reader.GetDecimal(2);
    this.AVSCDT = reader.GetString(3);
    this.AVMAJG = reader.GetString(4);
    this.AVMING = reader.GetString(5);
    this.AVDES1 = reader.GetString(6);
    this.AVDES2 = reader.GetString(7);
    this.AVUNTI = reader.GetString(8);
    this.AVBK01 = reader.GetString(9);
    this.AVTYPE = reader.GetString(10);
    this.AVTOTP = reader.GetDecimal(11);
    this.AVSHRK = reader.GetDecimal(12);
    this.AVBILL = reader.GetString(13);
    this.AVTAXR = reader.GetString(14);
    this.AVOPTR = reader.GetDecimal(15);
    this.AVMULT = reader.GetDecimal(16);
    this.AVQTYP = reader.GetDecimal(17);
    this.AVQTYA = reader.GetDecimal(18);
    this.AVQTYH = reader.GetDecimal(19);
    this.AVMINQ = reader.GetDecimal(20);
    this.AVMAXQ = reader.GetDecimal(21);
    this.AVYTDU = reader.GetDecimal(22);
    this.AVYTD1 = reader.GetDecimal(23);
    this.AVYTD2 = reader.GetDecimal(24);
    this.AVCUST = reader.GetString(25);
    this.AVCORG = reader.GetString(26);
    this.AVPLAN = reader.GetString(27);
    this.AVCPT = reader.GetString(28);
    this.AVREV = reader.GetString(29);
    this.AVPRUN = reader.GetDecimal(30);
    this.AVGLED = reader.GetString(31);
    this.AVENGC = reader.GetString(32);
    this.AVESTV = reader.GetDecimal(33);
    this.AVGLCD = reader.GetString(34);
    this.AVFEDC = reader.GetString(35);
    this.AVMAJS = reader.GetString(36);
    this.AVMINS = reader.GetString(37);
    this.AVLDAT = reader.GetDateTime(38);
    this.AVMINR = reader.GetDecimal(39);
    this.AVOQTY = reader.GetDecimal(40);
    this.AVCNTR = reader.GetString(41);
    this.AVBK04 = reader.GetString(42);
    this.AVREVL = reader.GetString(43);
    this.AVRDAT = reader.GetDateTime(44);
    this.AVNWHT = reader.GetDecimal(45);
    this.AVDES3 = reader.GetString(46);
    this.AVHARM = reader.GetString(47);
    this.AVBK06 = reader.GetString(48);
    this.AVOLDD = reader.GetString(49);
    this.AVDRWS = reader.GetString(50);
    this.AVDRWL = reader.GetString(51);
    this.AVUNTP = reader.GetString(52);
    this.AVLVL = reader.GetDecimal(53);
    this.AVMOQT = reader.GetDecimal(54);
    this.AVQTPO = reader.GetDecimal(55);
    this.AVPACK = reader.GetDecimal(56);
    this.AVPACU = reader.GetString(57);
    this.AVPRPT = reader.GetDecimal(58);
    this.AVNWUN = reader.GetString(59);
    this.AVSVOL = reader.GetDecimal(60);
    this.AVSVUN = reader.GetString(61);
    this.AVKITC = reader.GetString(62);
    this.AVUPCC = reader.GetString(63);
    this.AVABCC = reader.GetString("AVABCC");
    this.AVCLSS = reader.GetString("AVCLSS");
    this.AVSTAT = reader.GetString("AVSTAT");
