...
void load(NotNullDataReader reader){
    ...
    if (dataBaseAccess.getConnectionType() == DataBaseAccess.CMS_DATABASE){
        this.AWVPT = reader.GetString("AWVPT" + aux);
        this.AWREV = reader.GetString("AWREV" + aux);        
    }else{
    ...
    if (string.IsNullOrEmpty(AWSTAT))
        this.AWSTAT = "A";
}*/
	...
	if (Configuration.CmsVersion.Equals(Constants.CMS_VERSION_5_2)){
		...
		if (dataBaseAccess.getConnectionType() == DataBaseAccess.CMS_DATABASE){
            ...
            try{
                ...
                this.AWCTME = DateUtil.decimalMinutesToHoursHHMM(reader.GetDecimal("AWCTME"));
            }
            ...
            try{
                ...
                this.AWUTME = DateUtil.decimalMinutesToHoursHHMM(reader.GetDecimal("AWUTME"));
            }
			this.AWFUTQ = reader.GetDateTime("AWFUTQ");
			this.AWFUTR = reader.GetDateTime("AWFUTR");
			this.AWDDAT = reader.GetDateTime("AWDDAT");
            ...
            try{
                ...
                this.AWFUT41 = DateUtil.decimalMinutesToHoursHHMM(reader.GetDecimal("AWFUT41"));
            }			

            try{
                this.AWFUT42 = reader.GetDateTime("AWFUT42");
            }catch{
                this.AWFUT42 = DateUtil.decimalMinutesToHoursHHMM(reader.GetDecimal("AWFUT42"));
            }

            try{
                this.AWFUT43 = reader.GetDateTime("AWFUT43");
            }catch{
                this.AWFUT43 = DateUtil.decimalMinutesToHoursHHMM(reader.GetDecimal("AWFUT43"));
            }

            try{
                this.AWFUT44 = reader.GetDateTime("AWFUT44");
            }catch{
                this.AWFUT44 = DateUtil.decimalMinutesToHoursHHMM(reader.GetDecimal("AWFUT44"));
            }

            try{
                this.AWFUT45 = reader.GetDateTime("AWFUT45");
            }catch{
                this.AWFUT45 = DateUtil.decimalMinutesToHoursHHMM(reader.GetDecimal("AWFUT45"));
            }						
		//}
