...
public 
class VendDataBaseContainer : GenericDataBaseContainer{


public 
VendDataBaseContainer(DataBaseAccess dataBaseAccess) : base(dataBaseAccess){
}
...
void read(){
	...
	try{
		...
		reader = dataBaseAccess.executeQuery(sql);
		 while(reader.Read()){
			VendDataBase vendDataBase = new VendDataBase(dataBaseAccess);
			vendDataBase.load(reader);
			this.Add(vendDataBase);
		}
