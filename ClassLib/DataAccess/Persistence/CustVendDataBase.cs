...
void load(NotNullDataReader reader){
    ...
    this.CV_TPartner = reader.GetString("CV_TPartner");
}
...
void update(){
	...
	string sql = "update custvend set " +
        ...
        "CV_TPartner = '" + Converter.fixString(CV_TPartner) + "' " +
...
void write(){
	...
	string sql = "insert into custvend values('" + 
        ...
        Converter.fixString(CV_TPartner) + "')";               
...
public 
void setCV_TPartner(string CV_TPartner){
	this.CV_TPartner = CV_TPartner;
}
