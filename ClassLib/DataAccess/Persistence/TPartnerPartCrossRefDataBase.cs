...
public class TPartnerPartCrossRefDataBase : GenericDataBaseElement{
...
public TPartnerPartCrossRefDataBase(DataBaseAccess dataBaseAccess) : base(dataBaseAccess){
}
...
void write(){
	try{
		string sql = "insert into tpartnerpartcrossref values(" + 
