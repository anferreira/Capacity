...
public 
class TaskLogDataBase : GenericDataBaseElement{
...
public
TaskLogDataBase(DataBaseAccess dataBaseAccess) : base(dataBaseAccess){
}
...
void load(NotNullDataReader reader){
	...
	this.date = reader.GetString("date");
	this.time = reader.GetString("time");
...
void read(){
	...
	try{
		string sql = "select * from tasklog where id = " + id.ToString();
...
void write(){
	try{
		string sql = "insert into tasklog values(" + 
			id.ToString() + ", " +
			taskId.ToString() + ", " +
			priority.ToString() + ", '" +
			Converter.fixString(date) + "', '" +
			Converter.fixString(time) + "', '" +
...
void update(){
	try{
		string sql = "update tasklog set " +
			"taskId = " + taskId.ToString() + ", " +
			"priority = " + priority.ToString() + ", " +
			"date = '" + Converter.fixString(date) + "', " +
			"time = '" + Converter.fixString(time) + "', " +
...
void delete(){
	try{
		string sql = "delete from tasklog where id = " + id.ToString();
