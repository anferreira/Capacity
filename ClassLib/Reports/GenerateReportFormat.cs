...
public static 
string generateReport(ActiveReport3 rpt, DataSet dataSet, string dataMember, int type){
...
public static 
string generateReport(ActiveReport3 rpt, DataSet dataSet, string dataMember, int type, bool open){
    setReport(rpt, dataSet, dataMember);
    rpt.Run();
...
private static 
void setReport(ActiveReport3 rpt, DataSet dataSet,string dataMember){
...
private static 
string openReportFormat(ActiveReport3 rpt, int type, bool open){
