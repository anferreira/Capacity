...
public 
class rptHotListBomMartinRea : ActiveReport3{
...
#region ActiveReports Designer generated code
		...
		{
			this.LoadLayout(this.GetType(), "Nujit.NujitERP.ClassLib.Reports.TEMP.rptHotListBomMartinRea.rpx");
			...
			this.TextBox2 = ((DataDynamics.ActiveReports.TextBox)(this.PageHeader.Controls[14]));
			this.Label4 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[15]));
			this.Line1 = ((DataDynamics.ActiveReports.Line)(this.PageHeader.Controls[16]));
			this.Label30 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[17]));
			this.lblTitulo = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[18]));
			this.Label32 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[19]));
			this.Label33 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[20]));
			this.Label34 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[21]));
			this.Label35 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[22]));
			this.Label36 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[23]));
			this.Label37 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[24]));
			this.Label38 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[25]));
			this.Label39 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[26]));
			this.Label40 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[27]));
			this.Label41 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[28]));
			this.lvlTitle = ((DataDynamics.ActiveReports.TextBox)(this.PageHeader.Controls[29]));
			this.lblTit1 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[30]));
			this.lblTit2 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[31]));
