...
public 
class rptHotListHoursPartMartinRea : ActiveReport3{
...
private 
void PageHeader_BeforePrint(object sender, System.EventArgs eArgs){
	lblTit1.Text = "Hotlist Generated on : " + logVector[0];
	lblTit2.Text = "Material Explosion on : " + logVector[1];
...
#region ActiveReports Designer generated code
		...
		{
			this.LoadLayout(this.GetType(), "Nujit.NujitERP.ClassLib.Reports.HotList.rptHotListHoursPartMartinRea.rpx");
			...
			this.Label32 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[23]));
			this.Label33 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[24]));
			this.Label34 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[25]));
			this.Label35 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[26]));
			this.Label36 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[27]));
			this.Label37 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[28]));
			this.Label38 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[29]));
			this.Label39 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[30]));
			this.Label40 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[31]));
			this.Label41 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[32]));
			this.Label42 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[33]));
			this.Label43 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[34]));
			this.Label44 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[35]));
			this.Label45 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[36]));
			this.lblTit1 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[37]));
			this.lblTit2 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[38]));
			this.Label46 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[39]));
			...
			this.TextBox33 = ((DataDynamics.ActiveReports.TextBox)(this.Detail.Controls[21]));
