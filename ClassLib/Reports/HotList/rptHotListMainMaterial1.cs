...
public 
class rptHotListMainMaterial : ActiveReport3{
...
#region ActiveReports Designer generated code
		...
		{
			this.LoadLayout(this.GetType(), "Nujit.NujitERP.ClassLib.Reports.HotList.rptHotListMainMaterial.rpx");
