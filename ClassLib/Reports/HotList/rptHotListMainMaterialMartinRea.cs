...
public 
class rptHotListMainMaterialMartinRea : ActiveReport3{
...
public 
rptHotListMainMaterialMartinRea(){		
...
#region ActiveReports Designer generated code
		...
		private DataDynamics.ActiveReports.Label lblDescDeptHeader = null;
		...
		{
			this.LoadLayout(this.GetType(), "Nujit.NujitERP.ClassLib.Reports.HotList.rptHotListMainMaterialMartinRea.rpx");
			...
			this.Label31 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[22]));
			this.lblTitulo = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[23]));
			this.Label32 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[24]));
			this.Label33 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[25]));
			this.Label34 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[26]));
			this.lvlTitle = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[27]));
			this.lblTit1 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[28]));
			this.lblTit2 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[29]));
			this.Label35 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[30]));
			...
			this.lblDescDeptHeader = ((DataDynamics.ActiveReports.Label)(this.GroupHeader1.Controls[2]));
			...
			this.HOT_MainMaterial = ((DataDynamics.ActiveReports.TextBox)(this.Detail.Controls[21]));
			this.HOT_MainMaterialSeq = ((DataDynamics.ActiveReports.TextBox)(this.Detail.Controls[22]));
			this.HOT_MainMaterialQoh = ((DataDynamics.ActiveReports.TextBox)(this.Detail.Controls[23]));
			this.lvlTextBox = ((DataDynamics.ActiveReports.TextBox)(this.Detail.Controls[24]));
			this.MaterialDescription = ((DataDynamics.ActiveReports.TextBox)(this.Detail.Controls[25]));
			...
			this.Label14 = ((DataDynamics.ActiveReports.Label)(this.ReportFooter.Controls[20]));
			this.Label15 = ((DataDynamics.ActiveReports.Label)(this.ReportFooter.Controls[21]));
			this.Label16 = ((DataDynamics.ActiveReports.Label)(this.ReportFooter.Controls[22]));
			this.Label17 = ((DataDynamics.ActiveReports.Label)(this.ReportFooter.Controls[23]));
			this.Label18 = ((DataDynamics.ActiveReports.Label)(this.ReportFooter.Controls[24]));
			this.Label19 = ((DataDynamics.ActiveReports.Label)(this.ReportFooter.Controls[25]));
			this.Label20 = ((DataDynamics.ActiveReports.Label)(this.ReportFooter.Controls[26]));
			this.Label21 = ((DataDynamics.ActiveReports.Label)(this.ReportFooter.Controls[27]));
			this.Label22 = ((DataDynamics.ActiveReports.Label)(this.ReportFooter.Controls[28]));
			this.Label23 = ((DataDynamics.ActiveReports.Label)(this.ReportFooter.Controls[29]));
			this.Label24 = ((DataDynamics.ActiveReports.Label)(this.ReportFooter.Controls[30]));
			this.Label25 = ((DataDynamics.ActiveReports.Label)(this.ReportFooter.Controls[31]));
			this.Line3 = ((DataDynamics.ActiveReports.Line)(this.ReportFooter.Controls[32]));
