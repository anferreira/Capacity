...
public 
class rptHotListMajMinGroup : ActiveReport3{
...
#region ActiveReports Designer generated code
		...
		{
			this.LoadLayout(this.GetType(), "Nujit.NujitERP.ClassLib.Reports.HotList.rptHotListMajMinGroup.rpx");
