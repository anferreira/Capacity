...
namespace Nujit.NujitERP.ClassLib.Reports.HotList
{
	...
	public 
		class rptHotListMinGroupMM : ActiveReport3
	{
		...
		{
			this.LoadLayout(this.GetType(), "Nujit.NujitERP.ClassLib.Reports.HotList.rptHotListMinGroupMM.rpx");
