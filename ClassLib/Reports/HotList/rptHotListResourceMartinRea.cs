...
public 
class rptHotListResourceMartinRea : ActiveReport3{
...
void setBomReport(bool hotListBom){
	...
	this.lvlTitle.Visible = hotListBom;
	this.lvlTextBox.Visible = hotListBom;
}
...
#region ActiveReports Designer generated code
		...
		{
			this.LoadLayout(this.GetType(), "Nujit.NujitERP.ClassLib.Reports.HotList.rptHotListResourceMartinRea.rpx");
			...
			this.TextBox33 = ((DataDynamics.ActiveReports.TextBox)(this.GroupHeader1.Controls[2]));
