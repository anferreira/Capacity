...
public
class ShipReleaseColorConverter : IValueConverter{

public
object Convert(object value, Type targetType, object parameter, System.Globalization.CultureInfo cultureInfo){
     string scolor = "Black";
    
    if (value != null && value is ShipExportRelease){
        ShipExportRelease shipExportRelease = (ShipExportRelease)value;
        if (shipExportRelease.BQtyChangeShow || shipExportRelease.BDateChangeShow)        
            scolor = "Red";
    }
    return scolor;
}
