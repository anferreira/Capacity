...
public
class ShiftTaskComboColumnListView : ComboColumnListView{

public
ShiftTaskComboColumnListView(string title, string bindName, BindingMode bindingMode, int with, ListView listView)
