...
public static 
void generateReport(ActiveReport3 rpt, DataSet dataSet, string dataMember, int type){
    setReport(rpt, dataSet, dataMember);
    rpt.Run();
    openReportFormat(rpt, type);
}
...
private static 
void openReportFormat(ActiveReport3 rpt, int type){
