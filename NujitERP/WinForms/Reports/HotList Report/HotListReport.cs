...
public
class HotListReport : GenericReport{

private rptHotListMartinRea rpt = new rptHotListMartinRea();
private rptHotList rpt2 = new rptHotList();
...
public 
HotListReport(DataSet dataSet, string title, bool isHoursReport, bool labourReport, 
...
public 
HotListReport(DataSet dataSet, string title, bool accumOnFridays, bool isHoursReport, 
