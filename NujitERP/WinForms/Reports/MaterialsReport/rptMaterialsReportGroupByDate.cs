...
{
	public class rptMaterialsReportGroupByDate : ActiveReport3
	{

		private string label;

		public rptMaterialsReportGroupByDate()
		{
			InitializeReport();
		}
		...
		private void Detail_Format(object sender, System.EventArgs eArgs)
		{
			...
			if (label.Trim().Equals("Day"))
			{
				...
				lblEnt11.Text = begin.AddDays(10).ToShortDateString();
				lblEnt12.Text = begin.AddDays(11).ToShortDateString();
				lblEnt13.Text = begin.AddDays(12).ToShortDateString();
				lblEnt14.Text = begin.AddDays(13).ToShortDateString();
			}
			else
			{
				...
				lblEnt11.Text = DateUtil.getMonthName(begin.Month) + "-" + DateUtil.getMonthName(end.Month);
				barLbl2.Text += begin.Day.ToString("00") + "-" + end.Day.ToString("00") + "                  ";

				begin = end.AddDays(1);
				end = begin.AddDays(6);
				lblEnt12.Text = DateUtil.getMonthName(begin.Month) + "-" + DateUtil.getMonthName(end.Month);
				barLbl2.Text += begin.Day.ToString("00") + "-" + end.Day.ToString("00") + "                  ";

				begin = end.AddDays(1);
				end = begin.AddDays(6);
				lblEnt13.Text = DateUtil.getMonthName(begin.Month) + "-" + DateUtil.getMonthName(end.Month);
				barLbl2.Text += begin.Day.ToString("00") + "-" + end.Day.ToString("00") + "              ";

				begin = end.AddDays(1);
				end = begin.AddDays(6);
				lblEnt14.Text = DateUtil.getMonthName(begin.Month) + "-" + DateUtil.getMonthName(end.Month);
				barLbl2.Text += begin.Day.ToString("00") + "-" + end.Day.ToString("00");
			}
		...
		private DataDynamics.ActiveReports.Label lblEnt11 = null;
		private DataDynamics.ActiveReports.Label lblEnt12 = null;
		private DataDynamics.ActiveReports.Label lblEnt13 = null;
		private DataDynamics.ActiveReports.Label lblEnt14 = null;
		...
		private DataDynamics.ActiveReports.TextBox Ent12 = null;
		private DataDynamics.ActiveReports.TextBox Ent13 = null;
		private DataDynamics.ActiveReports.TextBox Ent14 = null;
		...
		{
			this.LoadLayout(this.GetType(), "Nujit.NujitERP.WinForms.Reports.MaterialsReport.rptMaterialsReportGroupByDate.rpx");
			...
			this.lblEnt1 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[5]));
			this.lblEnt2 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[6]));
			this.lblEnt3 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[7]));
			this.lblEnt4 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[8]));
			this.lblEnt5 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[9]));
			this.lblEnt6 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[10]));
			this.Label19 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[11]));
			this.lblEnt7 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[12]));
			this.Label21 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[13]));
			this.lblEnt8 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[14]));
			this.lblEnt9 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[15]));
			this.lblEnt10 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[16]));
			this.lblEnt11 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[17]));
			this.lblEnt12 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[18]));
			this.lblEnt13 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[19]));
			this.lblEnt14 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[20]));
			this.barLbl1 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[21]));
			this.barLbl2 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[22]));
			...
			this.Ent11 = ((DataDynamics.ActiveReports.TextBox)(this.Detail.Controls[15]));
			this.Ent12 = ((DataDynamics.ActiveReports.TextBox)(this.Detail.Controls[16]));
			this.Ent13 = ((DataDynamics.ActiveReports.TextBox)(this.Detail.Controls[17]));
			this.Ent14 = ((DataDynamics.ActiveReports.TextBox)(this.Detail.Controls[18]));
