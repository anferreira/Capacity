...
namespace Nujit.NujitERP.WinForms.Reports.MaterialsReport
{
	...
	public 
		class rptMaterialsReportGroupByDateVendor : ActiveReport3
	{
		...
		public 
			rptMaterialsReportGroupByDateVendor()
		{
	...
	"or.rpx");
			...
			this.Label27 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[16]));
			this.Label28 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[17]));
			this.Label29 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[18]));
			this.Label30 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[19]));
			this.barLbl1 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[20]));
			this.barLbl2 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[21]));
			this.Label8 = ((DataDynamics.ActiveReports.Label)(this.GroupHeader1.Controls[0]));
			this.supplierText = ((DataDynamics.ActiveReports.TextBox)(this.GroupHeader1.Controls[1]));
			...
			this.Label33 = ((DataDynamics.ActiveReports.Label)(this.GroupFooter1.Controls[0]));
			...
			void Detail_Format(object sender, System.EventArgs eArgs)
		{
			...
			else
			{
				...
				Label27.Text = DateUtil.getMonthName(begin.Month) + "-" + DateUtil.getMonthName(end.Month);
				barLbl2.Text += begin.Day.ToString("00") + "-" + end.Day.ToString("00") + "              ";
	
				begin = end.AddDays(1);
				end = begin.AddDays(6);
				Label28.Text = DateUtil.getMonthName(begin.Month) + "-" + DateUtil.getMonthName(end.Month);
				barLbl2.Text += begin.Day.ToString("00") + "-" + end.Day.ToString("00") + "                         ";
	
				begin = end.AddDays(1);
				end = begin.AddDays(6);
				Label29.Text = DateUtil.getMonthName(begin.Month) + "-" + DateUtil.getMonthName(end.Month);
				barLbl2.Text += begin.Day.ToString("00") + "-" + end.Day.ToString("00") + "              ";
	
				begin = end.AddDays(1);
				end = begin.AddDays(6);
				Label30.Text = DateUtil.getMonthName(begin.Month) + "-" + DateUtil.getMonthName(end.Month);
				barLbl2.Text += begin.Day.ToString("00") + "-" + end.Day.ToString("00");
			}
		}
