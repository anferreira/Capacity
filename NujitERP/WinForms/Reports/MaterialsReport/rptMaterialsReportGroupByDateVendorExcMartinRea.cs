...
namespace Nujit.NujitERP.WinForms.Reports.MaterialsReport
{
	...
	public 
		class rptMaterialsReportGroupByDateVendorExcMartinRea : ActiveReport3
	{
		...
		public 
			rptMaterialsReportGroupByDateVendorExcMartinRea()
		{
	...
	"orExcMartinRea.rpx");
			...
			this.Label33 = ((DataDynamics.ActiveReports.Label)(this.ReportHeader.Controls[20]));
			this.Label34 = ((DataDynamics.ActiveReports.Label)(this.ReportHeader.Controls[21]));
			...
			this.supplierText = ((DataDynamics.ActiveReports.TextBox)(this.Detail.Controls[13]));
			this.MaterialDescription = ((DataDynamics.ActiveReports.TextBox)(this.Detail.Controls[14]));
