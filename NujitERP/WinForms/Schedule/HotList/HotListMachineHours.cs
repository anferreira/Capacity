...
void loadGridHotList(bool charge){
	lock(this){
		...
		DataSet dsHotList = LoadHotListGrid.generateHotListHoursDataSet(hotListHourContainer, getDateLastHotListCreated());
