...
void loadGridHotList(){
	...
	string generated = "";
	string exploded = "";
    DateTime hotListCreated  = DateTime.Now;
	...
	if (!lastVersionCheckBox.Checked){
		...
		hotListCreated= DateUtil.parseCompleteDate(v[0],DateUtil.MMDDYYYY);
    }

    dsHotList = LoadHotListGrid.generateHotListDataSet(vecFilterDept, vecFilterPart, vecFilterMg, false, type, hlid, hotListCreated);
