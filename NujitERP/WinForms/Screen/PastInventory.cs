...
namespace Nujit.NujitERP.WinForms.Screens
{
	...
	/// </summary>
	public class PastInventory : System.Windows.Forms.Form
	{
		...
		public PastInventory(FormMain formParent)
		{
			InitializeComponent();
...
//				string dateLabel = start.ToShortDateString();
				...
				string dateLabel = start.AddDays(-i-1).ToShortDateString();
...
//				dataRow[1] = (i < 3)? "XM-GL-5002" : "XM-GL-5017";
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(PastInventory));
			...
			this.infoGrid.Size = new System.Drawing.Size(710, 303);
			...
			this.label12.Size = new System.Drawing.Size(742, 24);
			this.label12.TabIndex = 25;
			this.label12.Text = "Past Inventory";
