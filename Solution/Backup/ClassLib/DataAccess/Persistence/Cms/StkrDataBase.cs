...
void load(NotNullDataReader reader){
	this.AXSTKL = reader.GetString(0);
	this.AXLOCN = reader.GetString(1);
	this.AXLDAT = reader.GetDateTime(2);
	this.AXPLNT = reader.GetString(3);
	this.AXSTTP = reader.GetString(4);
	this.AXBK01 = reader.GetString(5);
	this.AXADR1 = reader.GetString(6);
	this.AXADR2 = reader.GetString(7);
	this.AXADR3 = reader.GetString(8);
	this.AXPOST = reader.GetString(9);
	this.AXTEL = reader.GetDecimal(10);
	this.AXHLD = reader.GetString(11);
	this.AXMRP = reader.GetString(12);
	this.AXQCSK = reader.GetString(13);
	this.AXBINC = reader.GetString(14);
	this.AXFLG1 = reader.GetString(15);
	this.AXFLG2 = reader.GetString(16);
	this.AXFLG3 = reader.GetString(17);
	this.AXFLG4 = reader.GetString(18);
	this.AXTXT1 = reader.GetString(19);
	this.AXTXT2 = reader.GetString(20);
	this.AXTXT3 = reader.GetString(21);
	this.AXTXT4 = reader.GetString(22);
}
