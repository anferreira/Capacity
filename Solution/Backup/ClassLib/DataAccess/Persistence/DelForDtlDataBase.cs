...
void load(NotNullDataReader reader){
	...
	this.DD_DelforQtyCum = reader.GetInt32("DD_DelforQtyCum");
	...
	try{
		string sql = "insert into delfordtl (DD_Key,DD_Db,DD_DelforReleaseNum,DD_DelforDate,DD_DelforTime," +
		            ...
		            "values(" + 
                        ...
                        DateUtil.getTimeRepresentation(DD_DelforTime) +"', '" +
...
public void setDD_DelforQtyCum (int DD_DelforQtyCum){
