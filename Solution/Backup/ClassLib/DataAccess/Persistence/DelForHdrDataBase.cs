...
private int DH_CumQty;
private int DH_CustCumRequired;
private int DH_CustCumShipped;
private int DH_FabCumQty;
private int DH_MatCumQty;
private int DH_LastRecQty;
private DateTime DH_LastRecDate;
private string DH_LastRecShipment;
private int DH_CumDisc;
...
void load(NotNullDataReader reader){
    ...
    this.DH_CumQty = reader.GetInt32("DH_CumQty");
    this.DH_CustCumRequired = reader.GetInt32("DH_CustCumRequired");
    this.DH_CustCumShipped = reader.GetInt32("DH_CustCumShipped");
    this.DH_FabCumQty = reader.GetInt32("DH_FabCumQty");
    this.DH_MatCumQty = reader.GetInt32("DH_MatCumQty");
    this.DH_LastRecQty = reader.GetInt32("DH_LastRecQty");
    this.DH_LastRecDate = reader.GetDateTime("DH_LastRecDate");
    this.DH_LastRecShipment = reader.GetString("DH_LastRecShipment");
    this.DH_CumDisc = reader.GetInt32("DH_CumDisc");
...
public void setDH_CumQty (int DH_CumQty){
    this.DH_CumQty = DH_CumQty;
}

public void setDH_CustCumRequired (int DH_CustCumRequired){
    this.DH_CustCumRequired = DH_CustCumRequired;
}

public void setDH_CustCumShipped (int DH_CustCumShipped){
    this.DH_CustCumShipped = DH_CustCumShipped;
}

public void setDH_FabCumQty (int DH_FabCumQty){
    this.DH_FabCumQty = DH_FabCumQty;
}

public void setDH_MatCumQty (int DH_MatCumQty){
    this.DH_MatCumQty = DH_MatCumQty;
}

public void setDH_LastRecQty (int DH_LastRecQty){
...
public void setDH_CumDisc (int DH_CumDisc){
...
public int getDH_CumQty(){
    return DH_CumQty;
}

public int getDH_CustCumRequired(){
    return DH_CustCumRequired;
}

public int getDH_CustCumShipped(){
    return DH_CustCumShipped;
}

public int getDH_FabCumQty(){
    return DH_FabCumQty;
}

public int getDH_MatCumQty(){
    return DH_MatCumQty;
}

public int getDH_LastRecQty(){
