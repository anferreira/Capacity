...
*   $Source: /usr/local/cvsroot/Projects/Nujit/ClassLib/DataAccess/Persistence/OrderEntry/OePSHdrDataBaseContainer.cs,v $ 
*   $State: Exp $ 
*   $Log: OePSHdrDataBaseContainer.cs,v $
...
public void truncate(){
	try{
		string sql = "delete from oepshdr";
