...
void load(NotNullDataReader reader){
	...
	this.PC_ProdLev = reader.GetString("PC_ProdLev");
...
void write(){
	try{
		string sql = "insert into prodfmactsub values('" + 
			...
			Converter.fixString(PC_ProdLev) + "', '" +
...
void update(){
		try{
		string sql = "update prodfmactsub set values('" + 
			...
			"PC_ProdLev = '" + Converter.fixString(PC_ProdLev) + "', " +
...
public
void setPC_ProdLev(string PC_ProdLev){
