...
public 
class ToolSchedule : System.Windows.Forms.Form{
...
//    DataRow dataRow;
	...
	dataTable.Columns.Add(new DataColumn("CompletionDate", typeof(string)));
	dataTable.Columns.Add(new DataColumn("Component#", typeof(string)));
	dataTable.Columns.Add(new DataColumn("Component Desc", typeof(decimal)));
	dataTable.Columns.Add(new DataColumn("Required Date", typeof(decimal)));
	dataTable.Columns.Add(new DataColumn("Start DateTime", typeof(decimal)));
	dataTable.Columns.Add(new DataColumn("EndDate Time", typeof(decimal)));
	dataTable.Columns.Add(new DataColumn("Machine Hours", typeof(string)));
	dataTable.Columns.Add(new DataColumn("Labour Hours", typeof(string)));		
	dataTable.Columns.Add(new DataColumn("Buffer Time	", typeof(decimal)));
