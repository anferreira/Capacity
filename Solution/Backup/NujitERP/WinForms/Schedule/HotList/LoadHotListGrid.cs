...
public static 
DataTable addColumnsHours(DataTable hotListDataTable){
	if (hotListDataTable.Columns.Count > 0)
		return hotListDataTable;
	...
	for(int i = 1; i < 61; i++)
		hotListDataTable.Columns.Add("Day " + i.ToString(), typeof(string));
	return hotListDataTable;
}

public static 
DataSet setColumnName(DataSet dsHotList){
	...
	dsHotList.Tables[0].Columns["HOT_MainMaterialQoh"].ColumnName = "M.M. Qty Avail";

	dsHotList.Tables[0].Columns["HOT_PastDue"].ColumnName = "Past Due";
	dsHotList.Tables[0].Columns["HOT_Day001"].ColumnName = "Today";
	dsHotList.Tables[0].Columns["HOT_Day002"].ColumnName = DateTime.Today.AddDays(1).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day003"].ColumnName = DateTime.Today.AddDays(2).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day004"].ColumnName = DateTime.Today.AddDays(3).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day005"].ColumnName = DateTime.Today.AddDays(4).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day006"].ColumnName = DateTime.Today.AddDays(5).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day007"].ColumnName = DateTime.Today.AddDays(6).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day008"].ColumnName = DateTime.Today.AddDays(7).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day009"].ColumnName = DateTime.Today.AddDays(8).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day010"].ColumnName = DateTime.Today.AddDays(9).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day011"].ColumnName = DateTime.Today.AddDays(10).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day012"].ColumnName = DateTime.Today.AddDays(11).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day013"].ColumnName = DateTime.Today.AddDays(12).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day014"].ColumnName = DateTime.Today.AddDays(13).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day015"].ColumnName = DateTime.Today.AddDays(14).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day016"].ColumnName = DateTime.Today.AddDays(15).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day017"].ColumnName = DateTime.Today.AddDays(16).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day018"].ColumnName = DateTime.Today.AddDays(17).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day019"].ColumnName = DateTime.Today.AddDays(18).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day020"].ColumnName = DateTime.Today.AddDays(19).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day021"].ColumnName = DateTime.Today.AddDays(20).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day022"].ColumnName = DateTime.Today.AddDays(21).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day023"].ColumnName = DateTime.Today.AddDays(22).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day024"].ColumnName = DateTime.Today.AddDays(23).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day025"].ColumnName = DateTime.Today.AddDays(24).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day026"].ColumnName = DateTime.Today.AddDays(25).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day027"].ColumnName = DateTime.Today.AddDays(26).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day028"].ColumnName = DateTime.Today.AddDays(27).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day029"].ColumnName = DateTime.Today.AddDays(28).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day030"].ColumnName = DateTime.Today.AddDays(29).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day031"].ColumnName = DateTime.Today.AddDays(30).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day032"].ColumnName = DateTime.Today.AddDays(31).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day033"].ColumnName = DateTime.Today.AddDays(32).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day034"].ColumnName = DateTime.Today.AddDays(33).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day035"].ColumnName = DateTime.Today.AddDays(34).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day036"].ColumnName = DateTime.Today.AddDays(35).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day037"].ColumnName = DateTime.Today.AddDays(36).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day038"].ColumnName = DateTime.Today.AddDays(37).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day039"].ColumnName = DateTime.Today.AddDays(38).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day040"].ColumnName = DateTime.Today.AddDays(39).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day041"].ColumnName = DateTime.Today.AddDays(40).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day042"].ColumnName = DateTime.Today.AddDays(41).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day043"].ColumnName = DateTime.Today.AddDays(42).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day044"].ColumnName = DateTime.Today.AddDays(43).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day045"].ColumnName = DateTime.Today.AddDays(44).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day046"].ColumnName = DateTime.Today.AddDays(45).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day047"].ColumnName = DateTime.Today.AddDays(46).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day048"].ColumnName = DateTime.Today.AddDays(47).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day049"].ColumnName = DateTime.Today.AddDays(48).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day050"].ColumnName = DateTime.Today.AddDays(49).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day051"].ColumnName = DateTime.Today.AddDays(50).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day052"].ColumnName = DateTime.Today.AddDays(51).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day053"].ColumnName = DateTime.Today.AddDays(52).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day054"].ColumnName = DateTime.Today.AddDays(53).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day055"].ColumnName = DateTime.Today.AddDays(54).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day056"].ColumnName = DateTime.Today.AddDays(55).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day057"].ColumnName = DateTime.Today.AddDays(56).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day058"].ColumnName = DateTime.Today.AddDays(57).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day059"].ColumnName = DateTime.Today.AddDays(58).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day060"].ColumnName = DateTime.Today.AddDays(59).ToString("ddd MM-dd");

	dsHotList.Tables[0].Columns["HOT_Day061"].ColumnName = DateTime.Today.AddDays(60).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day062"].ColumnName = DateTime.Today.AddDays(61).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day063"].ColumnName = DateTime.Today.AddDays(62).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day064"].ColumnName = DateTime.Today.AddDays(63).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day065"].ColumnName = DateTime.Today.AddDays(64).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day066"].ColumnName = DateTime.Today.AddDays(65).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day067"].ColumnName = DateTime.Today.AddDays(66).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day068"].ColumnName = DateTime.Today.AddDays(67).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day069"].ColumnName = DateTime.Today.AddDays(68).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day070"].ColumnName = DateTime.Today.AddDays(69).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day071"].ColumnName = DateTime.Today.AddDays(70).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day072"].ColumnName = DateTime.Today.AddDays(71).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day073"].ColumnName = DateTime.Today.AddDays(72).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day074"].ColumnName = DateTime.Today.AddDays(73).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day075"].ColumnName = DateTime.Today.AddDays(74).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day076"].ColumnName = DateTime.Today.AddDays(75).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day077"].ColumnName = DateTime.Today.AddDays(76).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day078"].ColumnName = DateTime.Today.AddDays(77).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day079"].ColumnName = DateTime.Today.AddDays(78).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day080"].ColumnName = DateTime.Today.AddDays(79).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day081"].ColumnName = DateTime.Today.AddDays(80).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day082"].ColumnName = DateTime.Today.AddDays(81).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day083"].ColumnName = DateTime.Today.AddDays(82).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day084"].ColumnName = DateTime.Today.AddDays(83).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day085"].ColumnName = DateTime.Today.AddDays(84).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day086"].ColumnName = DateTime.Today.AddDays(85).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day087"].ColumnName = DateTime.Today.AddDays(86).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day088"].ColumnName = DateTime.Today.AddDays(87).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day089"].ColumnName = DateTime.Today.AddDays(88).ToString("ddd MM-dd");
	dsHotList.Tables[0].Columns["HOT_Day090"].ColumnName = DateTime.Today.AddDays(89).ToString("ddd MM-dd");
...
public static 
DataSet generateHotListDataSet(bool onlyDemand, DataSet dataSet, DataTable hotListDataTable, int hlid){
	string[] filter = {};
	return generateHotListDataSet(filter, filter, filter, onlyDemand, "B", hlid);
}

public static 
DataSet generateHotListDataSet(string[] filterDept, string[] filterPart, string[] vecFilterMg, bool onlyDemand, string type, int hlid){
	DataRow dataRow;
...
public static 
DataSet generateHotListHoursDataSet(HotListHourContainer hotListHourContainer){
	DataRow dataRow;

	DataTable dataTable = LoadHotListGrid.addColumnsHours(new DataTable());
